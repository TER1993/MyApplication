...
import com.speedata.xu.myapplication.BuildConfig;
...
public final class Logcat {
    ...
    public static void v(@NotNull final Object... contents) {
        log(V, sConfig.mGlobalTag, contents);
    }

    public static void vTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(V, tag, contents);
    }

    public static void d(@NotNull final Object... contents) {
        log(D, sConfig.mGlobalTag, contents);
    }

    public static void dTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(D, tag, contents);
    }

    public static void i(@NotNull final Object... contents) {
        log(I, sConfig.mGlobalTag, contents);
    }

    public static void iTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(I, tag, contents);
    }

    public static void w(@NotNull final Object... contents) {
        log(W, sConfig.mGlobalTag, contents);
    }

    public static void wTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(W, tag, contents);
    }

    public static void e(@NotNull final Object... contents) {
        log(E, sConfig.mGlobalTag, contents);
    }

    public static void eTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(E, tag, contents);
    }

    public static void a(@NotNull final Object... contents) {
        log(A, sConfig.mGlobalTag, contents);
    }

    public static void aTag(@NotNull final String tag,@NotNull final Object... contents) {
        log(A, tag, contents);
    }

    public static void file(@NotNull final Object content) {
        log(FILE | D, sConfig.mGlobalTag, content);
    }

    public static void file(@TYPE final int type,@NotNull final Object content) {
        log(FILE | type, sConfig.mGlobalTag, content);
    }

    public static void file(@NotNull final String tag,@NotNull final Object content) {
        log(FILE | D, tag, content);
    }

    public static void file(@TYPE final int type,@NotNull final String tag,@NotNull final Object content) {
        log(FILE | type, tag, content);
    }

    public static void json(@NotNull final String content) {
        log(JSON | D, sConfig.mGlobalTag, content);
    }

    public static void json(@TYPE final int type,@NotNull final String content) {
        log(JSON | type, sConfig.mGlobalTag, content);
    }

    public static void json(@NotNull final String tag,@NotNull final String content) {
        log(JSON | D, tag, content);
    }

    public static void json(@TYPE final int type,@NotNull final String tag,@NotNull final String content) {
        log(JSON | type, tag, content);
    }

    public static void xml(@NotNull final String content) {
        log(XML | D, sConfig.mGlobalTag, content);
    }

    public static void xml(@TYPE final int type,@NotNull final String content) {
        log(XML | type, sConfig.mGlobalTag, content);
    }

    public static void xml(@NotNull final String tag, @NotNull final String content) {
        log(XML | D, tag, content);
    }

    public static void xml(@TYPE final int type,@NotNull final String tag,@NotNull final String content) {
    ...
    public static class Config {
        ...
        private String mGlobalTag = "TongHao";
        ...
        @NotNull
        public Config setGlobalTag(@NotNull final String tag) {
            if (isSpace(tag)) {
                mGlobalTag = "";
                mTagIsSpace = true;
            } else {
        ...
        @NotNull
        public Config setDir(@NotNull final String dir) {
            if (isSpace(dir)) {
                mDir = null;
            } else {
        ...
        @NotNull
        public Config setDir(@NotNull final File dir) {
            mDir = dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        @NotNull
        public Config setFilePrefix(@NotNull final String filePrefix) {
